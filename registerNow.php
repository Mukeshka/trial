...
$chkrcode=mysqli_query($con,"select * from `tbl_user` where `owncode`='".$rcode."'");
	...
	if($codeRow!=''){	
$sql= mysqli_query($con,"INSERT INTO `tbl_user` (`mobile`, `password`,`code`,`owncode`,`privacy`,`status`) VALUES ('".$mobile."',.md5($password)."','".$rcode."','','".$acceptTC."','1')");
...
$sql3= mysqli_query($con,"INSERT INTO `tbl_bonus`(`userid`,`amount`,`level1`,`level2`) VALUES ('".$userid."','0','150','0')");
